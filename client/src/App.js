    ...
    const wave = async () => {
        try {
            ...
            if (ethereum) {
                ...
                console.log(count);
                console.log(count._hex);
                console.log(count._isBigNumber);
    ...
    return (
        <div className="mainContainer">
            <div className="dataContainer">
                ...
                <div className="bio">
                    I am Vivien and I'm massively interested in shrinking the
                    government, in size and power!
                </div>
                ...
                <div className="wave-count">
                    Total waves: <strong>{waveCount}</strong>
                </div>
